...
public class LibraryService {
	...
	@RequestMapping(value = "/LAddUpdateLibBranch", method = RequestMethod.POST, consumes="application/json", produces="application/json")
	@Transactional
	...
	@RequestMapping(value = "/LdeleteLibBranch/{branchId}", method = RequestMethod.GET, produces="application/json")
	...
	@RequestMapping(value = "/LreadBranchByPk/{branchId}", method = RequestMethod.GET, produces="application/json")
	...
	@RequestMapping(value = "/LreadBranchByName/{branchName}", method = RequestMethod.GET, produces="application/json")
	...
	@RequestMapping(value = "/LreadBookCopies/{branchId}", method = RequestMethod.GET, produces="application/json")
	...
	@RequestMapping(value = "/LupdateBookCopies/{branchId}/{bookId}/{noCopies}", method = RequestMethod.GET, produces = "application/json")
	...
	@RequestMapping(value = "/LviewBranches", method = RequestMethod.GET, produces = "application/json")
	...
	@RequestMapping(value = "/LreadBCbyBookIdBranchId/{bookId}/{branchId}", method = RequestMethod.GET, produces="application/json")
	...
	@RequestMapping(value = "/LreadBorrowerName/{cardNo}", method = RequestMethod.GET, produces="application/json")
...
//	@RequestMapping(value = "/LviewBranchAndBooks/{branchId}", method = RequestMethod.GET, produces = "application/json")
