...
public class AdminService {
	...
	@RequestMapping(value = "/AsaveAuthor", method = RequestMethod.POST, consumes="application/json", produces="application/json")
	@Transactional
	...
	@RequestMapping(value = "/AdeleteAuthor/{authorId}", method = RequestMethod.GET, consumes="application/json", produces="application/json")
	...
	@RequestMapping(value = "/AviewAuthors/{searchString}/{pageNo}", method = RequestMethod.GET, produces="application/json")
	...
	@RequestMapping(value = "/AviewAllAuthors", method = RequestMethod.GET,  produces="application/json")
...
//				 a.setBooks(bdao.readAllBooksByAuthorID(a.getAuthorId()));
	...
	@RequestMapping(value = "/AreadAuthorByPk/{authorId}", method = RequestMethod.GET, produces="application/json")
	...
	// books
	@RequestMapping(value = "/AsaveBook", method = RequestMethod.POST, consumes="application/json", produces="application/json")
	@Transactional
	...
	@RequestMapping(value = "/AdeleteBook/{bookId}", method = RequestMethod.GET, produces="application/json")
	public void deleteBook(@PathVariable Integer bookId)
			throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException {
		bdao.deleteBookById(bookId);
	}
	
	@RequestMapping(value = "/AviewBooks/{searchString}/{pageNo}", method = RequestMethod.GET, produces="application/json")
	...
	@RequestMapping(value = "/AreadBookByPk/{bookId}", method = RequestMethod.GET, produces="application/json")
	...
	// Publisher
		...
		@RequestMapping(value = "/AreadPublisherByPk/{publisherId}", method = RequestMethod.GET, produces="application/json")
		...
		@RequestMapping(value = "/AviewAllPublishers", method = RequestMethod.GET,  produces="application/json")
		...
		@RequestMapping(value = "/AsavePublisher", method = RequestMethod.POST, consumes="application/json", produces="application/json")
		@Transactional
		...
		@RequestMapping(value = "/AdeletePublisher/{publisherId}", method = RequestMethod.GET, produces="application/json")
		...
		@RequestMapping(value = "/AviewAllBookLoans", method = RequestMethod.GET,  produces="application/json")
		...
		@RequestMapping(value = "/AoverrideDueDate/{dueDate}/{noOfDays}/{bookId}/{branchId}/{cardNo}", method = RequestMethod.GET, produces="application/json")
		...
		@RequestMapping(value = "/AreadBorrowerByPk/{cardNo}", method = RequestMethod.GET, produces="application/json")
		...
		@RequestMapping(value = "/AviewAllBorrowers", method = RequestMethod.GET,  produces="application/json")
		...
		@RequestMapping(value = "/AsaveBorrower", method = RequestMethod.POST, consumes="application/json", produces="application/json")
		@Transactional
		...
		@RequestMapping(value = "/AdeleteBorrower/{cardNo}", method = RequestMethod.GET, produces="application/json")
		...
		@RequestMapping(value = "/AreadBranchByPk/{branchId}", method = RequestMethod.GET, produces="application/json")
		...
		@RequestMapping(value = "/AviewAllBranches", method = RequestMethod.GET,  produces="application/json")
		...
		@RequestMapping(value = "/AsaveBranch", method = RequestMethod.POST, consumes="application/json", produces="application/json")
		@Transactional
		...
		@RequestMapping(value = "/AdeleteBranch/{branchId}", method = RequestMethod.GET, produces="application/json")
