...
public class BorrowerService {
	...
	@RequestMapping(value = "/BcardValidation/{cardNo}", method = RequestMethod.GET, produces = "application/json")
	...
	@RequestMapping(value = "/BviewBookLoans/{cardNo}", method = RequestMethod.GET, produces = "application/json")
	...
	@RequestMapping(value = "/BbookCheckIn/{bookId}/{branchId}/{cardNo}", method = RequestMethod.GET, produces = "application/json")
	...
	@RequestMapping(value = "/BcheckOut/{cardNo}/{bookId}/{branchId}", method = RequestMethod.GET, produces = "application/json")
